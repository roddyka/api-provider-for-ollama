...
/**
 * Plugin Name: AI Provider for Ollama Local
 ...
 * Requires PHP: 7.4
 * Version: 0.1.0
 * Update URI: https://github.com/roddyka/api-provider-for-ollama
 * Author: roddyka
...
function register_connector($registry): void
{
    ...
    $registry->register(
        $connectorId,
        [
            'name' => __('Ollama Local', 'ai-provider-for-ollama-local'),
 ...
 * @since 0.1.0
 */
const CONNECTOR_SCRIPT_MODULE_ID = 'ai-provider-for-ollama-local/connector';
...
{
    register_rest_route(
        'ai-provider-for-ollama-local/v1',
        '/settings',
        [
            'methods'             => 'POST',
...
function filter_connector_card_script_module_data(array $data): array
{
    ...
    $data['restPath']         = '/ai-provider-for-ollama-local/v1/settings';
